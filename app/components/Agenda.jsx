    ...
    return (
        <AnimatedSection>
            <section className={`${props.font[0].className} flex flex-col bg-white h-screen relative`}>
                <h1 className={`${props.font[1].className} lg:text-8xl text-6xl ml-10 mt-14 lg:ml-14 text-black`}>Agenda</h1>
                <div className={`${props.font[0].className} grow flex lg:justify-end justify-center items-center flex-row`}>
